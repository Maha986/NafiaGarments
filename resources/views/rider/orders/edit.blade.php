            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="card-title mb-3"style="text-align: right;">                                   <td>
            <a href="{{ route('rider_defer',$order) }}" class="btn btn-raised btn-raised-success m-1" style="color: white">Defer / Delay</a></div>
                        <form class="forms-sample" method="POST" action="{{ route('rider_order.update',$order) }}">
                            @csrf()
                            @method('PUT')
                            <div class="row">
