                        ...
                        <nav class="toolbox">
                            ...
                            <div class="toolbox-right">
                                <div class="toolbox-item toolbox-show">
                                    ...
                                    <label><a href="{{ $catagories->previousPageUrl()}}" rel="prev">← Previous</a>
                                    <a href="{{$catagories->nextPageUrl()}}" rel="next"> Next →</a>
                                </label>
                                    <!-- <a href="{{$catagories->nextPageUrl()}}" rel="next">Next →</a></li> -->
...
@endforelse
                                  ...
                                  $discountt = App\Models\GeneralDiscount::where('product_id',$cat->id)->first();
                                    @endphp

                                    @if($discountt!=null)
                                        <div class="label-group">
                                            <span class="product-label label-sale">-{{$discountt->discount}}%</span>
                                        </div>
                                    @endif
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="price-box">
                                            ...
                                            <span class="product-price">Rs {{$cat->price}}</span>
                                        </div><!-- End .price-box -->
...
<center>
                    ...
                    <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
                        <div class="sidebar-wrapper">
                            ...
                            <form action="{{route('pricefilter_all')}}"method="get">
                                            @csrf
