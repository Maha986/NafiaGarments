...
@section('content')
    <input type="hidden" value="{{$activePage = 'catalogueIndex', $title = 'Create Catalogue - Nafia Garments'}}">
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Create New Catalogue</div>
                        <form class="forms-sample" method="POST" action="{{ route('catalogue.store') }}">
                            @csrf()
