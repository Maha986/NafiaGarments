...
@section('content')
    ...
    <input type="hidden" value="{{$activePage = 'Nafia', $title = 'Invoice - Nafia Garments'}}">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="upper p-4">
                    ...
                    <div class="transaction mt-2">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex flex-row align-items-center"> <i class="fa fa-check-circle-o"></i> <span class="ml-2"><a href="{{route('accept2',$invoice->id)}}" class="btn btn-primary float-right">PROCEED</a> </span> </div>
      <span class="font-weight-bold"><a href="{{route('decline2',$invoice->id)}}" class="btn btn-primary float-right">DECLINE</a></span>
                        </div>
                    </div>
