        ...
        <div class="row mb-4">
            <div class="col-md-12 mb-4">
                <div class="card text-left">
                    <div class="card-body">
                        <h4 class="card-title mb-3" style="display: inline;">Your Sales</h4>
                      
                            <div class="row">
                                  <div class="col-6">
 <form class="forms-sample" method="POST" action="{{route('tofrom_orderreport_reseller')}}" enctype="multipart/form-data">
    @csrf
               ...
               <tr>
                ...
                <td> {{$or->product_quantity}} </td>
                  <td> {{$or->size}} </td>
                    ...
                    @php
                       $discount = App\Models\GeneralDiscount::where('product_id',$or->product_id)->first();
                    @endphp
                       ...
                       @endif
                       @if($discount!=null)
                       <td>{{ $or->product_quantity*$or->total_price-$discount->discount*$or->quantity}} </td>
                       @else
                       <td>{{$or->product_quantity*$or->total_price}} </td>
                       @endif
                       <td>{{$or->product_weight}}</td>
                       <td>{{$product->commission_amount }}</td>
                       <td></td>
                       <td></td>
                       <td>{{$or->product_weight+$or->total_price}}</td>
            </tr>
