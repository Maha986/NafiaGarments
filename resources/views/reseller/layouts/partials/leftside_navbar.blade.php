...
{{--        </ul>--}}
  ...
  <ul class="childNav" data-parent="reports">
                ...
                <li class="nav-item {{$activePage == 'generaldiscountIndex' ? 'active' : ''}}"><a href="{{route('salesreport_reseller')}}"><i class="nav-icon fas fa-badge-percent"></i><span class="item-name">Sales Report </span></a></li>
        ...
        <ul class="childNav" data-parent="reports">
                ...
                <li class="nav-item {{$activePage == 'generaldiscountIndex' ? 'active' : ''}}"><a href="{{route('orderstatus_reseller')}}"><i class="nav-icon fas fa-badge-percent"></i><span class="item-name">Order Status </span></a></li>
         
        </ul>

         <ul class="childNav" data-parent="reports">
      
                <li class="nav-item {{$activePage == 'generaldiscountIndex' ? 'active' : ''}}"><a href="{{route('discount_reseller')}}"><i class="nav-icon fas fa-badge-percent"></i><span class="item-name">Discounts </span></a></li>
         
        </ul>

          <ul class="childNav" data-parent="reports">
      
                <li class="nav-item {{$activePage == 'generaldiscountIndex' ? 'active' : ''}}"><a href="{{route('offer_reseller')}}"><i class="nav-icon fas fa-badge-percent"></i><span class="item-name">Offers </span></a></li>
