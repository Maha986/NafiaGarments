...
@section('content')
    <input type="hidden" value="{{$activePage = 'roleIndex', $title = 'Create Role - Nafia Garments'}}">
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Create New Role</div>
                        <form class="forms-sample" method="POST" action="{{ route('role.store') }}">
                            @csrf()
                            <div class="form-group">
                                <label>New Role</label>

                                <input type="text" name="role" class="form-control @error('role') is-invalid @enderror" placeholder="Enter New Role" value="{{ old('role') }}" aria-label="role">
                                @error('role')
