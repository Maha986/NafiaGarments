    ...
    <div class="row">
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasPermissionTo('voucher-create'))
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Create Bank Payment Voucher</div>
                        <form method="POST" action="bankpaymentvoucher">
                            @csrf
                            <div class="row">
     @php
     ...
     @endphp
                                ...
                                <div class="col-md-6 form-group mb-3">
                                 ...
                                 <div class="col-md-6 form-group mb-3">
                                    <label for="accountnumber">Account Number Reference</label>
                                    <input class="form-control" id="accountnumber" name="accountnumber" type="text" required/>
                                </div>

                                    <div class="col-md-12 form-group mb-3">
                                    <label for="chequeno">Cheque No</label>
                                    <input class="form-control" id="chequeno" name="chequeno" type="text" required/>
                                </div>


                                  <div class="col-md-6 form-group mb-3">
                                    <label for="lastName1">Select Category/Account Code</label>
                                    <select name="accountcode[]" id="nameid" class="form-control">
                                   
         <option value=""disabled>Select Account Code</option>@foreach($accountcode as $code)<option value="{{$code->code}}">{{$code->name}}({{$code->code}})</option>@endforeach
