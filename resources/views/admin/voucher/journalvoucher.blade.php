    ...
    <div class="row">
        ...
        @if(auth()->user()->hasRole('super-admin') || auth()->user()->hasPermissionTo('voucher-create'))
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-title mb-3">Create Journal Voucher</div>
                        <form method="POST" action="journalvoucher">
                            @csrf
                            <div class="row">
     ...
     @endphp
                                  ...
                                  <div class="col-md-6 form-group mb-3">
                                    <label for="ledger">Ledger Reference</label>
                                    <input class="form-control" id="ledger" name="ledger" type="text" required/>
                                </div>
