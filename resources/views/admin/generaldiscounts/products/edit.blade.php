                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <select class="form-control @error('deal_for') is-invalid @enderror" id="deal_for" name="deal_for">
                                        ...
                                        <option {{ $generaldiscount->deal_for == "customer" ? 'selected':'' }}  value="customer"> Customer </option>
                                        <option {{ $generaldiscount->deal_for == "reseller" ? 'selected':'' }}  value="reseller"> Reseller </option>
                                    </select>
                                    @error('deal_for')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <select class="form-control js-example-basic-single @error('specific_deal_for') is-invalid @enderror" id="specific_deal_for" name="specific_deal_for">
                                        @if($generaldiscount->deal_for == 'customer')

                                            @if(!is_null($generaldiscount->specific_deal_for))

                                                <option value="{{ $generaldiscount->specific_deal_for }}"> {{ \App\Models\Customer::where('id',$generaldiscount->specific_deal_for)->first()->email }} </option>

                                            @endif

                                        @elseif($generaldiscount->deal_for == 'reseller')

                                            @if(!is_null($generaldiscount->specific_deal_for))

                                                <option value="{{ $generaldiscount->specific_deal_for }}"> {{ \App\Models\Reseller::where('id',$generaldiscount->specific_deal_for)->first()->email }} </option>
