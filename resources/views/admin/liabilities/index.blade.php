...
@section('content')
    <input type="hidden" value="{{$activePage = 'accountsIndex', $title = 'Liabilities - Nafia Garments'}}">
    <div class="row">
        @if(session('success'))
            ...
            <!-- <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form method="POST" action="liabilitystore">
                            @csrf
                            <div class="row">
        ...
        @endif
            <!-- <div class="col-md-12 mb-3">
                <div class="card text-left">
                    <div class="card-body">
                        <h4 class="card-title mb-3">All Liabilities Related To Sales</h4>
