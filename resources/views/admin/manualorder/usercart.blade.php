                            ...
                            <table class="display table table-striped table-bordered" id="zero_configuration_table" style="width:100%">
                               ...
                               @foreach($cuser as $user)
                                    <tr>
                                        ...
                                        <td><a href="{{route('admincart',$user->id)}}" class="btn btn-raised btn-raised-success m-1" style="color: white">View Cart</a></td>
                                        <td>
                                            <form method="get" action="{{route('checkoutadmincart',$user->id)}}">
                                                @csrf
